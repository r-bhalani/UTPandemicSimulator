...
class Student(BasePerson):
    ...
    def __init__(self,
        ...
        self._school = school
        # Increased the amount of time, since college students spend most of their day on campus
        self._school_time = school_time or SimTimeTuple(hours=tuple(range(9, 17)), week_days=tuple(range(0, 5)))
        self._routines = []
