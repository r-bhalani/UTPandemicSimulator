...
ut_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(GroceryStore, num=3, num_assignees=5, state_opts=dict(visitor_capacity=30)),
        LocationConfig(Campus, num=10, num_assignees=4, state_opts=dict(visitor_capacity=50)),
        LocationConfig(HybridCampus, num=10, num_assignees=4, state_opts=dict(visitor_capacity=40)),
        LocationConfig(Party, num=4, num_assignees=4, state_opts=dict(visitor_capacity=15)),
        LocationConfig(Hospital, num=4, num_assignees=30, state_opts=dict(patient_capacity=10)),
        LocationConfig(RetailStore, num=4, num_assignees=5, state_opts=dict(visitor_capacity=10)),
        ...
        LocationConfig(Bar, num=2, num_assignees=5, state_opts=dict(visitor_capacity=12)),
    ],
