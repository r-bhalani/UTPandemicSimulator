...
ut_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(Dorm, num=150),
        LocationConfig(GroceryStore, num=3, num_assignees=5, state_opts=dict(visitor_capacity=3)),
        LocationConfig(Campus, num=5, num_assignees=4, state_opts=dict(visitor_capacity=5)),
        LocationConfig(HybridCampus, num=5, num_assignees=4, state_opts=dict(visitor_capacity=5)),
        LocationConfig(Party, num=2, num_assignees=4, state_opts=dict(visitor_capacity=5)),
        LocationConfig(Hospital, num=2, num_assignees=30, state_opts=dict(patient_capacity=5)),
        LocationConfig(RetailStore, num=2, num_assignees=5, state_opts=dict(visitor_capacity=5)),
        LocationConfig(HairSalon, num=2, num_assignees=3, state_opts=dict(visitor_capacity=5)),
        LocationConfig(Restaurant, num=2, num_assignees=6, state_opts=dict(visitor_capacity=5)),
        LocationConfig(Bar, num=2, num_assignees=5, state_opts=dict(visitor_capacity=5)),
    ],
